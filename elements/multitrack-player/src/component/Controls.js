...
import { defineCustomElements as defineBtnIconComponent } from './BtnIcon';
import { defineCustomElements as defineSeekComponent } from './Seek';
...
export class ControlComponent extends LitElement {
  ...
  zoomin() {
    this.dispatchEvent(new Event('zoomin-click', { bubbles: true }));
  }

  zoomout() {
    this.dispatchEvent(new Event('zoomout-click', { bubbles: true }));
  }
