...
import { defineCustomElements as defineControlComponent, ControlComponent } from './Controls';
import { defineCustomElements as defineStemsListComponent } from './StemsList';
import { defineCustomElements as defineMaskComponent } from './Mask';
import { defineCustomElements as defineIconComponent } from './Icon';
...
export class PlayerComponent extends LitElement {
  ...
  constructor() {
    ...
    this.addEventListener('zoomin-click', this.onZoomin);
    this.addEventListener('zoomout-click', this.onZoomout);
  ...
  /**
   * Gets the currentTime of playback
   * @returns {Number}
   */
  get currentTime() {
