import { Observer, withOrientation, style, clamp } from './util';
...
export default class Drawer extends Observer {
  ...
  constructor(container, params) {
    ...
    this.container = withOrientation(container, params.vertical);
    /**
  ...
  setupWrapperEvents() {
    this.wrapper.addEventListener('click', (e) => {
      const orientedEvent = withOrientation(e, this.params.vertical);
